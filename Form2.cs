...
namespace Arvin_Transport_And_Trading
{
    public partial class Form2 : Form
    {
        ...
        //private void OpenChildForm(FormCar formCar, object sender)
        //{
        ...
        {
            OpenChildForm(new Forms.FormRental(), sender);
        ...
        private void Reset()
        {
            DisableButton();
            lblTitle.Text = "HOME";
            panelTitleBer.BackColor = Color.FromArgb(0, 150, 136);
        ...
        private void panelTitleBer_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
